...
public class ListMenu extends GraphicMenu {
	 ...
	 * @param icons Not needed, because this menu does not use icons.
	 * @param topRow
	 */
    public ListMenu(String[] items, int topRow)
    {
    	super(items, null, topRow);
    }
	 ...
	 * @param icons Not needed, because this menu does not use icons.
	 */
	public ListMenu(String[] items)
	{
		this(items, 1);
    }
    
    /**
     * Constructs menu from List instance.
     * @param items List of items to be displayed.
     */
    public ListMenu(List<String> items)
    {
    	this((String[])items.toArray(), 1);
    }
